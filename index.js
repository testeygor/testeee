		...
		try {
			...
			mess = {
				...
				only: {
					...
					ownerG: '[❗] Este comando só pode ser usado pelo grupo proprietário!(neverland😌) ❌',
					ownerB: '[❗] Este comando só pode ser usado pelo neverland! ❌',
			...
			const ownerNumber = ["5511985395703@s.whatsapp.net"] // replace this with your number
			...
			const isOwner = ownerNumber.includes(sender)
                        ...
                        const NomerOwner = '5511985395703@s.whatsapp.net'
                        /******ApiKey Input******/
